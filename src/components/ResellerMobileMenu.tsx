...
export default function ResellerMobileMenu({ currentPage }: ResellerMobileMenuProps) {
  const [isOpen, setIsOpen] = useState(false)

  const links = [
    { href: '/reseller', label: 'Painel' },
    { href: '/reseller#credits', label: 'Créditos' },
    ...
    { href: '/reseller/purchases', label: 'Minhas Compras' },
